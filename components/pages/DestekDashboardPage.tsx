...
interface ClubRow {
  ...
  closed: number;
  created: number;
  avgOpenHours: number; // ortalama açık kalma süresi (saat)
  slaCompliance: number; // %
}

// Baz veri = GÜNLÜK (created: 30-40/kulüp, open: günün bir kısmı kapanmadan kalır)
const CLUBS: ClubRow[] = [
  { id: 22,  name: "Akbatı",                   city: "İstanbul", type: "MACFit",  open: 18, closed: 22, created: 40,  avgOpenHours: 52, slaCompliance: 72 },
  { id: 6,   name: "Mall of Istanbul",          city: "İstanbul", type: "MACFit",  open: 16, closed: 21, created: 37,  avgOpenHours: 48, slaCompliance: 75 },
  { id: 11,  name: "Axis Kağıthane",            city: "İstanbul", type: "MACFit",  open: 15, closed: 20, created: 35,  avgOpenHours: 61, slaCompliance: 68 },
  { id: 2,   name: "Ankamall",                  city: "Ankara",   type: "MACFit",  open: 14, closed: 20, created: 34,  avgOpenHours: 44, slaCompliance: 79 },
  { id: 21,  name: "Armada",                    city: "Ankara",   type: "MACFit",  open: 13, closed: 21, created: 34,  avgOpenHours: 39, slaCompliance: 82 },
  { id: 34,  name: "Maltepe Pasco Plaza",       city: "İstanbul", type: "MACFit",  open: 12, closed: 20, created: 32,  avgOpenHours: 55, slaCompliance: 71 },
  { id: 3,   name: "Buyaka",                    city: "İstanbul", type: "MACFit",  open: 11, closed: 22, created: 33,  avgOpenHours: 33, slaCompliance: 88 },
  { id: 14,  name: "Fulya",                     city: "İstanbul", type: "MACFit",  open: 11, closed: 20, created: 31,  avgOpenHours: 42, slaCompliance: 80 },
  { id: 23,  name: "Kanyon",                    city: "İstanbul", type: "MAC/One", open: 10, closed: 23, created: 33,  avgOpenHours: 29, slaCompliance: 91 },
  { id: 9,   name: "Forum Kidsmall",            city: "İzmir",    type: "MACFit",  open: 10, closed: 20, created: 30,  avgOpenHours: 67, slaCompliance: 66 },
  { id: 32,  name: "Kocaeli Gebze Center",      city: "Kocaeli",  type: "MACFit",  open: 9,  closed: 21, created: 30,  avgOpenHours: 38, slaCompliance: 83 },
  { id: 13,  name: "Metrogarden",               city: "İstanbul", type: "MACFit",  open: 9,  closed: 21, created: 30,  avgOpenHours: 45, slaCompliance: 77 },
  { id: 1,   name: "Anadolu Hisarı",            city: "İstanbul", type: "MACFit",  open: 8,  closed: 22, created: 30,  avgOpenHours: 31, slaCompliance: 89 },
  { id: 33,  name: "Antalya Lara Carrefour",    city: "Antalya",  type: "MACFit",  open: 8,  closed: 22, created: 30,  avgOpenHours: 58, slaCompliance: 70 },
  { id: 29,  name: "Cadde",                     city: "İstanbul", type: "MACFit",  open: 7,  closed: 23, created: 30,  avgOpenHours: 36, slaCompliance: 84 },
  { id: 25,  name: "Panora",                    city: "Ankara",   type: "MAC/One", open: 7,  closed: 24, created: 31,  avgOpenHours: 27, slaCompliance: 93 },
  { id: 15,  name: "Bursa Podyumpark",          city: "Bursa",    type: "MACFit",  open: 7,  closed: 23, created: 30,  avgOpenHours: 41, slaCompliance: 81 },
  { id: 31,  name: "Kartal",                    city: "İstanbul", type: "MACFit",  open: 6,  closed: 24, created: 30,  avgOpenHours: 22, slaCompliance: 94 },
  { id: 8,   name: "Vialand",                   city: "İstanbul", type: "MACFit",  open: 6,  closed: 24, created: 30,  avgOpenHours: 49, slaCompliance: 76 },
  { id: 12,  name: "Adana Optimum",             city: "Adana",    type: "MACFit",  open: 6,  closed: 24, created: 30,  avgOpenHours: 53, slaCompliance: 73 },
  { id: 35,  name: "Podium",                    city: "Ankara",   type: "MACFit",  open: 5,  closed: 25, created: 30,  avgOpenHours: 19, slaCompliance: 95 },
  { id: 28,  name: "Ortaköy Lotus",             city: "İstanbul", type: "MAC/One", open: 5,  closed: 26, created: 31,  avgOpenHours: 24, slaCompliance: 92 },
  { id: 20,  name: "Ömür Plaza",                city: "İstanbul", type: "MACFit",  open: 5,  closed: 25, created: 30,  avgOpenHours: 44, slaCompliance: 78 },
  { id: 5,   name: "Ormanada",                  city: "İstanbul", type: "MAC/One", open: 4,  closed: 26, created: 30,  avgOpenHours: 18, slaCompliance: 97 },
  { id: 17,  name: "A Plus",                    city: "İstanbul", type: "MAC/One", open: 3,  closed: 27, created: 30,  avgOpenHours: 15, slaCompliance: 98 },
];

type SortKey  = "open" | "closed" | "created" | "avgOpenHours" | "slaCompliance";
