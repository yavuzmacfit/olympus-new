...
import { Home, BarChart2, Users, Calendar, ChevronUp, ChevronDown, ChevronLeft, Bookmark, Percent, Ticket, List, Landmark, UserPlus, Snowflake, Banknote, Dumbbell, CalendarDays, Users2, BookOpen, Package, Headphones, BarChart3, Building2, LayoutDashboard, Tag } from "lucide-react";
...
const navItemsByModule: Record<string, NavItem[]> = {
  ...
  "destek-islemleri": [
    ...
    { icon: Tag, label: "Kategori Raporu", id: "kategori-raporu" },
  ],
};
